...
if ( is_user_logged_in() ):
	...
	<form id="rcp_profile_editor_form" class="rcp_form" action="<?php echo rcp_get_current_url(); ?>" method="post">
		<fieldset>
			...
			<h2 class="form-title"><?php _e( 'User Profile Information', 'rcp' ); ?></h2>
			<p class="subheading">This information is only viewable by you and the Primemovers administrative team.</p>
			...
			<p id="rcp_profile_password_confirm_wrap">
				<label for="rcp_user_pass"><?php _e( 'Re-enter New Password', 'rcp' ); ?></label>
